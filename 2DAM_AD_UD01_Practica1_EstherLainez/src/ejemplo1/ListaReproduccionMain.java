...
public class ListaReproduccionMain {
	...
	public static void main(String[] args) throws IOException{
		...
		do {
			...
			System.out.println("|3.-Consultar datos de una cancion   |");
			System.out.println("|4.-Modificar año de la cancion      |");
			System.out.println("|5.-Borrar informacion de una cancion|");	
			...
			File f = new File("src/ejemplo1/ad_3_listaReproduccion.dat");
			...
			case 2: 				
				...
				if(!l.existeID(id)) {
					...
					System.out.println("Introduce si es una cancion española(true) o extranjera(false)");			
					cancion_espaniola=teclado.nextBoolean();
					
					l = new Cancion(id,anio,titulo,artista,duracion,cancion_espaniola);
			...
			case 3: 
				do {					
					System.out.println("Introduce el ID de la cancion a consultar (El ID tiene que seer mayor que 0)");
					id=teclado.nextInt();
				}while(id<=0);
				...
				if(l.existeID(id)) {
					...
					System.out.println("Id: "+id+" Año: "+anio+" Titulo: "+titulo+" Artista: "+artista+" Duracion: "+duracion+" ¿Cancion española?: "+cancion_espaniola);
				}else
					System.out.println("No existe ninguna cancion con ese ID");				
				break;
				
			case 4: 
				do {					
					System.out.println("Introduce el ID de la cancion para modificar su año (El ID tiene que seer mayor que 0)");
					id=teclado.nextInt();
				}while(id<=0);
			...
			case 5: 
				do {					
					System.out.println("Introduce el ID de la cancion para borrarla (El ID tiene que seer mayor que 0)");
					id=teclado.nextInt();
				}while(id<=0);
				...
				try {
					...
					do {						
						...
						if(id==-1) {
							...
							System.out.println("Id: "+id+" AÃ±o: "+anio+" Titulo: "+titulo+" Artista: "+artista+" DuraciÃ³n: "+duracion+" Â¿CanciÃ³n espaÃ±ola?: "+cancion_espaniola);
						}					
						posicion += 69;
					...
					System.out.println("No hay ninguna cancion borrada");
				}	
				break;
			case 7: 
				try {
					posicion=0;
					do {						
						raf.seek(posicion);//Nos situamos en un lugar determinado del fichero para empezar a leer desde alli
						id=raf.readInt();	
						if(id!=-1) {
							anio=raf.readInt();	
					...
					System.out.println("No hay ninguna cancion en la lista");
				}	
				break;
			...
			default:
				System.out.println("ERROR, debe introducir un numero entre el 1 y el 8");
			}
